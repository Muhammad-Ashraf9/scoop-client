          ...
          <div className="offcanvas offcanvas-end" tabIndex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
            ...
            <div className="offcanvas-body">
              <ul className="navbar-nav me-auto mb-2 mt-lg-2 ">
                ...
                <div className="NI dropdown togBtn" onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>
                  <a className=" dropdown-toggle" id="navbarDropdownMenuLink-1" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    Clothes
                  </a>
                  <ul  className={`text-danger dropdown-menu ${isOpen ? 'show' : ''}`} aria-labelledby="navbarDropdownMenuLink">
                    <li><a className="dropdown-item" href="#">Bra</a></li>
